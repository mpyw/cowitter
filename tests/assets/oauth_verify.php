...
function verify_oauth_1a($send_content_type = true)
{
    ...
    $expected_signature = base64_encode(hash_hmac(
        ...
        implode('&', array_map('rawurlencode', [
            ...
            'https://localhost:8081' . parse_url(filter_input(INPUT_SERVER, 'REQUEST_URI'), PHP_URL_PATH),
    ...
    fwrite(fopen('php://stderr', 'wb'), print_r([
        filter_input(INPUT_SERVER, 'REQUEST_METHOD'),
        'https://localhost:8081' . parse_url(filter_input(INPUT_SERVER, 'REQUEST_URI'), PHP_URL_PATH),
        http_build_query($base, '', '&', PHP_QUERY_RFC3986),
        $expected_signature,
